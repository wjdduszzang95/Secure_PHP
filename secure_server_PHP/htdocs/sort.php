...
<?php
                ...
                $query ="select * from board order by $sort desc";    
        ...
        <?php echo ('<h2 align=center> 완성된 쿼리:' . $query . '</h2>');?>
        <table align = center>
        <thead align = "center">
        <tr>
        <td width = "50" align="center">번호</td>
        <td width = "80" align="center"><a href = "sort.php?sort=<?php echo 'id' ?>">번호정렬</a></td>
        <td width = "500" align = "center">제목</td>
        <td width = "80" align="center"><a href = "sort.php?sort=<?php echo 'title' ?>">제목정렬</a></td>
        </tr>
        </thead>
        <tbody>
        <?php
